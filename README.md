...
Build Instructions for Ubuntu (see details in the original repo)
-----------------------------

This branch was created to build and use camodocal from Visual Studio on Windows and to provide support for vcpkg team to create a lib to use Cammodocal.
-----------------------------